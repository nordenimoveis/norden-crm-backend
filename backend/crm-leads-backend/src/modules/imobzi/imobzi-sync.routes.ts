...
import { ImobziSyncService } from './imobzi-sync.service';
...
export async function imobziSyncRoutes(app: FastifyInstance) {
  const service = new ImobziSyncService(app.prisma);
