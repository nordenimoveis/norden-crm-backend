...
const envSchema = z.object({
  ...
  // Cloudinary — armazenamento de imagens/vídeos/documentos das campanhas.
  // Opcionais: sem elas, tudo continua funcionando, só a peça de upload de
  // mídia fica indisponível (retorna erro claro se tentarem usar sem configurar).
